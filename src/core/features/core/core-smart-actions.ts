...
export const coreSmartActions = defineFeature({
  id: 'core-smart-actions',
  name: 'Smart Actions',
   category: 'Core',
  description:
  ...
  detectHints: ['smart action', 'generate commit message', 'copilot fix', 'copilot rename', 'inline/fix'],
  impact: 'medium',
  difficulty: 'low',
  setupSteps: [
