...
export const coreAgentsWindow = defineFeature({
  ...
  category: 'Core',
  description:
    'A dedicated VS Code window purpose-built for agent-driven development across multiple projects. Lets you explore, iterate, and review agentic tasks in parallel sessions while choosing your agent harness and running agents on remote machines.',
  ...
  setupSteps: [
    ...
    'Work across multiple projects by opening additional sessions from the session list.',
